...
self 0.0001 FlowerPetalUncolored 0.33 FlowerPetalRed 0.33 FlowerPetalGreen 0.33 FlowerPetalBlue\n\
...
item items[MAXNUMBEROFELEMENTS];
particle particles[MAXSIZE];
...
bool Sand::OnInit()
{
  ...
  doLimit = limitCB->IsChecked();
	...
	CalculateThread* calc = new CalculateThread();
	calc->Create();
	calc->Run();
